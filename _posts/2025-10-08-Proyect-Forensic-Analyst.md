...
seo_description: Professional forensic analysis of the phishing incident at Invent S.L. (Australia branch). Includes IoC extraction from PCAP, correlation tests, containment plan, and security recommendations.
