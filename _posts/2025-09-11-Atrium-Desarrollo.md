...
toc_sticky: true
header:
  overlay_image: /assets/img/headers/wackopicko-banner.jpg
  overlay_filter: 0.7
og_image: /assets/img/headers/wackopicko-og.png
...
![image-center](/assets/img/headers/wackopicko-banner.jpg){: .align-center}
...
![VegaScan](/assets/img/posts/atrium-desarrollo/vega.png)
![BurpSuite](/assets/img/posts/atrium-desarrollo/burp.png)
...
![Gobuster](/assets/img/posts/atrium-desarrollo/gobuster.png)
...
![Creacion User Vega](/assets/img/posts/atrium-desarrollo/vega_user.png)
...
![User panel](/assets/img/posts/atrium-desarrollo/usertest.png)
...
![User Login](/assets/img/posts/atrium-desarrollo/userlogin.png)
...
![User Login](/assets/img/posts/atrium-desarrollo/burpuser.png)

Comparación de acceso al panel:  
![scanner1 Login](/assets/img/posts/atrium-desarrollo/scanner1login.png)
...
![scanner1 Login](/assets/img/posts/atrium-desarrollo/scanner2.png)

Fuerza bruta en usuarios obtenidos, logrando comprometer sus credenciales:  
![BruteForce User](/assets/img/posts/atrium-desarrollo/userbrute.png)
...
![BruteForce User](/assets/img/posts/atrium-desarrollo/hydrabryce.png)
...
![BruteForce User](/assets/img/posts/atrium-desarrollo/burprespon.png)
...
![XSS Alert](/assets/img/posts/atrium-desarrollo/xssalert1.png)
...
- ![CMD codigo](/assets/img/posts/atrium-desarrollo/cmdphp.png)
- ![Cat /etc/passwd](/assets/img/posts/atrium-desarrollo/catetc.png)
...
![RevShell](/assets/img/posts/atrium-desarrollo/shellrev.png)
...
![Code php Reverse](/assets/img/posts/atrium-desarrollo/phpcoderever.png)
