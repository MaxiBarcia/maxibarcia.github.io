...
toc_sticky: true
header:
  overlay_image: /assets/img/headers/dvwa-banner.jpg
  overlay_filter: 0.7
  og_image: /assets/img/headers/dvwa-banner.jpg
...
![XSS Alert Low](/assets/img/posts/DVWA/xss-js-low.png)
...
```
![XSS Alert Medium](/assets/img/posts/DVWA/xss-js-medium.png)
...
![User Create XSS](/assets/img/posts/DVWA/user-create-xss.png)
...
?>
```
![XSS PHP script](/assets/img/posts/DVWA/php-cookie.png)
![XSS Listering cookie](/assets/img/posts/DVWA/listerin-cookie-reci.png)
